...
@Component({
      ...
      >
        <div class="flex items-center gap-2 w-full px-3 py-2.5">
          <div
            ...
            [ngClass]="{
              'text-blue-500  dark:text-blue-200': toast.config.type === 'info',
        ...
        <div class="w-full bg-gray-200 h-1 dark:bg-gray-700">
          <div
            ...
            [ngClass]="{
              ...
              'bg-green-600 dark:bg-green-500': toast.config.type === 'success',
  ...
  styles: `
    ...
    .fade-slide-in {
      animation: fadeSlideIn 0.35s cubic-bezier(0.17, 0.89, 0.24, 1.11);
    }
